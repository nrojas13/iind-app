  ...
  ngOnInit() {
    this.route.params.subscribe(
      (params: Params) => {
        ...
        this.http.get('https://iindinfo.herokuapp.com/cursos/' + this.curso_id)
  ...
  onCrearProfesor() {
    ...
    this.http.post("https://iindinfo.herokuapp.com/profesores/", JSON.stringify(this.profesor), { headers: headers })
      ...
      .subscribe(result1 => {
        ...
        this.http.post("https://iindinfo.herokuapp.com/profesores/" + profesor.id + "/asignar_curso", JSON.stringify(json), { headers: headers })
        .subscribe(result2 => {
          this.showAlert();
        });
      });
