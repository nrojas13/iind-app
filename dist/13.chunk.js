...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__curso_component__ = __webpack_require__(788);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__curso_routing_module__ = __webpack_require__(806);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ng2_smart_table__ = __webpack_require__(726);
...
CursoModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            __WEBPACK_IMPORTED_MODULE_5__curso_routing_module__["a" /* CursoRoutingModule */],
        ...
        declarations: [__WEBPACK_IMPORTED_MODULE_4__curso_component__["a" /* CursoComponent */]]
    })
], CursoModule);
...
var CursoComponent = (function () {
    function CursoComponent(route, http) {
        this.route = route;
        this.http = http;
        this.curso = {};
        this.profesores = [];
    ...
    CursoComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            _this.curso_id = params.id;
            _this.http.get('https://iindinfo.herokuapp.com/cursos/' + _this.curso_id)
                .map(function (response) { return response.json(); })
                .subscribe(function (result) {
                _this.curso = result;
                _this.profesores = _this.curso.profesores;
                console.log(_this.curso);
            });
        });
    };
    CursoComponent.prototype.onCrearProfesor = function () {
        var _this = this;
        var headers = new __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        this.http.post("https://iindinfo.herokuapp.com/profesores/", JSON.stringify(this.profesor), { headers: headers })
            .map(function (res) { return res.json(); })
            .subscribe(function (result1) {
            var profesor = result1;
            console.log(profesor.id);
            var json = {
                curso_id: _this.curso_id,
                profesor_id: profesor.id
            };
            _this.http.post("https://iindinfo.herokuapp.com/profesores/" + profesor.id + "/asignar_curso", JSON.stringify(json), { headers: headers })
                .subscribe(function (result2) {
                _this.showAlert();
            });
        });
    };
    CursoComponent.prototype.showAlert = function () {
        swal({
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__curso_component__ = __webpack_require__(788);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CursoRoutingModule; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_2__curso_component__["a" /* CursoComponent */],
        data: {
            title: 'Curso'
        }
    }
];
var CursoRoutingModule = (function () {
...
// module
exports.push([module.i, ".titulo {\n  margin-bottom: 20px; }\n\n.indicadores {\n  margin-bottom: 20px;\n  margin-left: 1px;\n  margin-right: 1px;\n  border-radius: 5px;\n  background: white;\n  border: 1px solid rgba(0, 0, 0, 0.15);\n  padding: 10px; }\n\n.equipo, .crear-profesor {\n  padding: 10px;\n  border-radius: 5px;\n  margin-bottom: 10px; }\n\n.crear-profesor input, .crear-profesor select, .crear-profesor button {\n  border-radius: 5px; }\n", ""]);
...
module.exports = "<h2 class=\"titulo\">{{ curso.nombre_curso }}</h2>\n<div class=\"row indicadores\">\n  <div class=\"col-sm-3\">\n    <div class=\"callout callout-info\">\n      <small class=\"text-muted\">Inscritos</small><br>\n      <strong class=\"h4\">{{curso.inscritos}}</strong>\n    </div>\n  </div><!--/.col-->\n  <div class=\"col-sm-3\">\n    <div class=\"callout callout-danger\">\n      <small class=\"text-muted\">Profesores</small><br>\n      <strong class=\"h4\">{{this.profesores.length}}</strong>\n    </div>\n  </div><!--/.col-->\n  <div class=\"col-sm-3\">\n    <div class=\"callout callout-warning\">\n      <small class=\"text-muted\">Plazas Calculadas</small><br>\n      <strong class=\"h4\">{{curso.monitores_requeridos}}</strong>\n    </div>\n  </div><!--/.col-->\n  <div class=\"col-sm-3\">\n    <div class=\"callout callout-success\">\n      <small class=\"text-muted\">Monitores Seleccionados</small><br>\n      <strong class=\"h4\">{{curso.monitores_solicitados}}</strong>\n    </div>\n  </div><!--/.col-->\n</div><!--/.row-->\n<div class=\"row\">\n  <div class=\"col-md-8\">\n    <div class=\"equipo form-control\">\n      <h4>Equipo</h4>\n      <ng2-smart-table class=\"form-control\" [settings]=\"settings\" [source]=\"profesores\"></ng2-smart-table>\n    </div>\n  </div>\n  <div class=\"col-md-4\">\n    <div class=\"crear-profesor form-control\">\n      <h4>Crear Profesor</h4>\n      <form (ngSubmit)=\"onCrearProfesor()\">\n        <div class=\"form-group\">\n          <label for=\"exampleInputEmail1\">Nombres</label>\n          <input type=\"text\" [(ngModel)]=\"profesor.nombres\" class=\"form-control\" name=\"nombres\" placeholder=\"Pepito Andrés\">\n        </div>\n        <div class=\"form-group\">\n          <label for=\"exampleInputEmail1\">Apellidos</label>\n          <input type=\"text\" [(ngModel)]=\"profesor.apellidos\" class=\"form-control\" name=\"apellidos\" placeholder=\"Pérez\">\n        </div>\n        <div class=\"form-group\">\n          <label for=\"exampleInputEmail1\">Correo uniandes</label>\n          <input type=\"email\" [(ngModel)]=\"profesor.email\" class=\"form-control\" name=\"correo\" placeholder=\"pa.perez@uniandes.edu.co\">\n        </div>\n        <div class=\"form-group\">\n          <label for=\"tipo\">Tipo</label>\n          <select class=\"form-control\" name=\"tipo\" id=\"tipo\" [(ngModel)]=\"profesor.tipo\">\n            <option value=\"Profesor\">Profesor</option>\n            <option value=\"Profesor\">Asistente Graduado</option>\n          </select>\n        </div>\n        <div class=\"form-group\">\n          <button type=\"submit\" class=\"btn btn-success col\">Crear profesor</button>\n        </div>\n      </form>\n    </div>\n  </div>\n</div>"
